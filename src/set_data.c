...
ssize_t put_data_in_buffer(t_woody *woody, void *origin_file,
  ...
  char code[] =
      "\x52\x57\x56\x52\x48\x8d\x1d\xf5\xff\xff\xff\x53\xbf\x01\x00\x00\x00\x48"
      "\x8d\x35\x59\x00\x00\x00\xba\x0a\x00\x00\x00\xb8\x01\x00\x00\x00\x0f\x05"
      "\x48\x31\xdb\x48\x8d\x3d\x57\x00\x00\x00\x48\x8d\x35\x58\x00\x00\x00\x8a"
      "\x05\x4a\x00\x00\x00\x48\x8d\x15\x39\x00\x00\x00\x48\x01\xda\x32"
      "\x02\x88\x07\x48\xff\xc7\x48\xff\xc3\x48\x3b\x1d\x2e\x00\x00\x00\x7c\x03"
      "\x48\x31\xdb\x48\xff\xce\x75\xd5\x5e\x5f\x5a\x5a\x5b\x48\x8d\x05\x29\x00"
      "\x00\x00\x48\x2b\x18\xff\xe3\x2e\x2e\x57\x4f\x4f\x44\x59\x2e\x2e\x0a\x41"
      "\x41\x41\x41\x41\x41\x41\x41\x41\x42\x88\x77\x66\x55\x44\x33\x22\x11\x88"
      "\x77\x66\x55\x44\x33\x22\x11\x88\x77\x66\x55\x44\x33\x22\x11";
...
void patch_data(t_woody *woody, ssize_t count) {
  ...
  ft_memcpy(((woody->file + count) - 33), tmp, 8);
}
